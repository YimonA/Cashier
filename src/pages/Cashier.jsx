...
const Cashier = () => {
  ...
  const { cartItems, currentItem, tax, totalCost, taxCost } = useSelector(
  ...
  const sampleData = [
    {
      ...
      unit: "dozen",
      more_information:
        "Quas non ad quas aspernatur ducimus eos cupiditate et. Sapiente et et officiis incidunt. Aut consectetur quo nihil.",
      photo: null,
      create_at: "19-10-23",
      update_at: "19-10-23",
    },
    {
      ...
      unit: "single",
      more_information:
        "Dignissimos aliquid vero tenetur quisquam. Qui culpa ut nostrum omnis et sunt quia. Accusantium id modi quia veritatis repudiandae accusamus sed. Odio dolorum non voluptate enim.",
      photo: null,
      create_at: "19-10-23",
      update_at: "19-10-23",
    },
    {
      ...
      unit: "single",
      more_information:
        "Nulla quas quo laborum. Necessitatibus cupiditate esse fuga illum repellat qui. Officia natus pariatur quo ut unde rerum. Odio in quia maiores porro illum debitis voluptatem architecto.",
      photo: null,
      create_at: "19-10-23",
      update_at: "19-10-23",
    },
      ...
      <div className=" flex justify-center items-stretch ">
        ...
        <div className=" basis-1/4 flex flex-col min-h-full bg-[var(--sidebar-color)]">
          ...
          <div className="bg-[var(--sidebar-color)] h-full p-1">
            ...
            <div className="item-height overflow-y-scroll scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-slate-800">
              {/* cart items start */}
              {cartItems.map((item) => {
                return (
                  <div
                    ...
                    <div className="flex justify-between items-center px-5">
                      <div>
                        ...
                        <p className=" text-[var(--gray-color)] text-[14px] font-normal">
                          {item?.quantity} Qty / Unit Price {item?.sale_price}{" "}
                          Ks
                        </p>
                        <p className=" text-[var(--gray-color)] text-[14px] font-normal">
